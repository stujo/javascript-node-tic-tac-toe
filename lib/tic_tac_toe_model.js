...
TicTacToeModel.prototype.imagineRecommendedMoveScore = function() {
    ...
    return this.imagineScore(recommendedState, this.otherPlayer()) / this.inceptionLevel;
}
...
TicTacToeModel.prototype.imagineScore = function(imaginedState, nextTurn) {
    var imaginedBoard = new TicTacToeModel(imaginedState, nextTurn, this.inceptionLevel + 1);
   
    var summary = imaginedBoard.boardSummary();
